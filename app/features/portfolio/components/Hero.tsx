    ...
    >
      <Flex p={10} direction="column">
        <Container maxW="900px" centerContent textAlign="center">
          ...
          <Spacer h={2} />
          <Flex maxW="60ch" color="white" flexWrap="wrap" flexDirection={["column"]} gap={2}>
            ...
            <Text flex={1} color="gray.300">
              Have a look through some of our recent work. We specialise in
              sleek, premium feeling user interfaces that delight users.
            </Text>
          </Flex>
        </Container>
      </Flex>
