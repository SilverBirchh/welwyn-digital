      ...
      <Container id="web-apps" p={10} maxW="900px" centerContent>
        ...
        <Flex direction={["column", "row"]} gap={10}>
          <Text flex={1}>
            ...
            include authentication, storage and API's. We choose technologies
            that are right for the job and can work best for your needs.
          </Text>
          <Text flex={1}>
            We have clear pricing models and hosting solutions that serve your
            site to users as fast as possible. Sites are distributed close to
            your users. Finally, we take security very seriously. No
            unauthorized access, on high bills and no surprises.
          </Text>
        </Flex>
        <Spacer flexBasis={5} />
        <Divider />
