    ...
    >
      <Box position="relative">
        ...
        <Box px={{ base: 4, sm: 6, md: 8 }} py={{ base: 20, sm: 24, lg: 28 }}>
          <ChakraBox style={{ y: titleY }} pos="relative" maxW="5xl" mx="auto">
            <Heading
              as="h1"
              color="white"
            ...
            <Text
              ...
              mx="auto"
            >
              We're here to support and scale up your business. We build
              beautiful websites tied with thoughtful marketing campaigns. Let
              Welwyn Digital elevate your business.
            </Text>
